...
sigma_i=3.7/2.5;%the sigma of the Gaussian distribution from which we draw bend angle of each step
...
for i=1:n_steps
    ...
    if i==1 | i==2 %does not mark first point to create the characteristic void in the middle of the nunchuck
        continue
    end
